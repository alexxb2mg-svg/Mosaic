"""Grilles typées — idée d'l'auteur (12/08 ~02h) : router chaque TYPE de donnée vers SA grille.
...
les lectures par grille. Corollaire d'l'auteur : la séparation permet peut-être de
...
def main() -> int:
    ...
    print("=== Grilles typées (idée de l'auteur 12/08) — expérience contrôlée ===")
    print(
        f"corpus : {corpus}",
